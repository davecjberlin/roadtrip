...
client.getEntry('2wpDjoBTfmkEuCqsmsKwME')
.then((entry) => {
  document.getElementById('name').innerHTML = entry.fields.name
  document.getElementById('description').innerHTML = entry.fields.description
})
// client.getEntries({
